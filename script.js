...
const BRACKET_STRUCTURE = {
  R32L: [
    { id: 'M74', label: 'C1 vs B2',        date: '06/28' },
    { id: 'M77', label: 'I1 vs J2',        date: '06/28' },
    { id: 'M73', label: 'A1 vs 3rd',       date: '06/28' },
    { id: 'M75', label: 'E1 vs 3rd',       date: '06/29' },
    { id: 'M83', label: 'H1 vs 3rd',       date: '06/30' },
    { id: 'M84', label: 'K1 vs 3rd',       date: '07/01' },
    { id: 'M81', label: 'L1 vs 3rd',       date: '07/01' },
    { id: 'M82', label: 'G1 vs 3rd',       date: '07/01' },
  ],
  R32R: [
    { id: 'M76', label: 'B1 vs A2',        date: '06/29' },
    { id: 'M78', label: 'J1 vs I2',        date: '06/29' },
    { id: 'M79', label: 'D1 vs C2',        date: '07/01' },
    { id: 'M80', label: 'F1 vs E2',        date: '07/01' },
    { id: 'M86', label: 'J1 vs H2',        date: '07/03' },
    { id: 'M88', label: 'D2 vs G2',        date: '07/03' },
    { id: 'M85', label: 'H2 vs G2',        date: '07/03' },
    { id: 'M87', label: 'K2 vs L2',        date: '07/03' },
  ],
  R16L: [
    { id: 'M89', label: 'W74 vs W77', date: '07/04' },
    { id: 'M90', label: 'W73 vs W75', date: '07/04' },
    { id: 'M93', label: 'W83 vs W84', date: '07/06' },
    { id: 'M94', label: 'W81 vs W82', date: '07/07' },
  ],
  R16R: [
    { id: 'M91', label: 'W76 vs W78', date: '07/05' },
    { id: 'M92', label: 'W79 vs W80', date: '07/06' },
    { id: 'M95', label: 'W86 vs W88', date: '07/07' },
    { id: 'M96', label: 'W85 vs W87', date: '07/07' },
  ],
  QFL: [
    { id: 'M97',  label: 'W89 vs W90', date: '07/09' },
    { id: 'M98',  label: 'W93 vs W94', date: '07/10' },
  ],
  QFR: [
    { id: 'M99',  label: 'W91 vs W92', date: '07/11' },
    { id: 'M100', label: 'W95 vs W96', date: '07/12' },
  ],
  SFL:   [{ id: 'M101', label: 'W97 vs W98',   date: '07/14' }],
  SFR:   [{ id: 'M102', label: 'W99 vs W100',  date: '07/15' }],
  FINAL: [{ id: 'M104', label: 'Final',         date: '07/19' }],
  THIRD: [{ id: 'M103', label: '3rd Place',     date: '07/18' }],
};
